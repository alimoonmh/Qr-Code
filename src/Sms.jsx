     ...
     <div
        ...
        <Button
          ...
          <div className='flex w-[100%] justify-between'>
            <div>Enter Sms <DriveFileRenameOutlineIcon/></div>
            <div><AddIcon/></div>
          </div>
        </Button>
        {openurl == false
          ? (
            <div className=' w-[85%] flex flex-col gap-3'>
              <div>
                <h1 className='text-[#007D51]'>Your Sms </h1>
              </div>
              <div>
      <div className="pb-2">          <TextField
                  onChange={(e) => {
      ...
      <div
       ...
       onClick={()=>{ const qrCodeCanvas = document.getElementById("sms") ; const link = document.createElement('a'); link.href = qrCodeCanvas.toDataURL(); link.download = 'qrcode.png'; link.click();}}
       >
        download
       </button>
      </div>
