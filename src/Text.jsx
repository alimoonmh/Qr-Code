  ...
  return (
    <div>
      <div
        ...
        <Button
          ...
          <div className='flex w-[100%] justify-between'>
            <div>Enter Text <DriveFileRenameOutlineIcon/></div>
            <div><AddIcon/></div>
          </div>
        </Button>
        {openurl == false
          ? (
            <div className=' w-[85%] flex flex-col gap-3'>
              <div>
                <h1 className='text-[#007D51]'>Your Text</h1>
              </div>
              <div>
      ...
      <div
       ...
       onClick={()=>{ const qrCodeCanvas = document.getElementById("text") ; const link = document.createElement('a'); link.href = qrCodeCanvas.toDataURL(); link.download = 'qrcode.png'; link.click();}}
       >
        download
       </button>
